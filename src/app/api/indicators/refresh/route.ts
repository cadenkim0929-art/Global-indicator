...
export async function POST() {
  ...
  try {
    ...
    return NextResponse.json({
      ok: true,
      result: { ...parsed, industrialProduction: industrialProductionSummary, derived, pmi: pmiSummary },
      stderr: [refresh.stderr, industrialProduction.stderr, derive.stderr, pmi.stderr].filter(Boolean).join('\n') || undefined,
